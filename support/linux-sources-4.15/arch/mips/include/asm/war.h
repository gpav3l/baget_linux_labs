...
/*
 * SRISA K64P core erratum:
 *	A write to the CP0 UserLocal register overwrites the CP0 Context
 *	register.
 */
#ifndef SRISA_K64P_ULR_WAR
#error Check setting of SRISA_K64P_ULR_WAR for your platform
#endif
